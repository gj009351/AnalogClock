 ...
 * minutes.
 */
public class AnalogClockCustomDrawable extends View {
    ...
    public AnalogClockCustomDrawable(Context context) {
        this(context, null);
    }

    public AnalogClockCustomDrawable(Context context, AttributeSet attrs) {
    ...
    public AnalogClockCustomDrawable(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AnalogClockCustomDrawable);
        mDotRadius = a.getDimension(R.styleable.AnalogClockCustomDrawable_dialRadius, 0);
        mDotOffset = a.getDimension(R.styleable.AnalogClockCustomDrawable_needleOffset, 0);
        final int dotColor = a.getColor(R.styleable.AnalogClockCustomDrawable_needleColor, Color.WHITE);
        if (dotColor != 0) {
  ...
  //      long millis = System.currentTimeMillis() % 1000;
    ...
    private final Runnable mClockTick = new Runnable () {
        ...
        public void run() {
            onTimeChanged();
            invalidate();
            AnalogClockCustomDrawable.this.postDelayed(mClockTick, 1000);
        }
    };
